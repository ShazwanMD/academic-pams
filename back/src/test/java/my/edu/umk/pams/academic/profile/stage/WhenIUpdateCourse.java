...
@JGivenStage
public class WhenIUpdateCourse extends Stage<WhenIUpdateCourse> {

    private static final Logger LOG = LoggerFactory.getLogger(WhenIUpdateCourse.class);
    ...
    public WhenIUpdateCourse I_update_course_to_faculty_code_$a(String FACULTY_CODE) {
