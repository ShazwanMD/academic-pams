...
public class US_AD_SPL_1001 extends SpringScenarioTest<GivenIAmCPSAdministrator, WhenIAddAProgram, ThenProgramIsIntroduced> {

    private static final Logger LOG = LoggerFactory.getLogger(US_AD_SPL_1001.class);
