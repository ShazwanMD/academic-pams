...
public interface TermService {
	...
	List<AdOffering> findOfferings(String filter, AdAcademicSession academicSession, AdProgram program, Integer offset,
			Integer limit);
	...
	List<AdSection> findSections(String filter, AdAcademicSession academicSession, AdAdmission admission,
	...
	List<AdEnrollmentApplication> findEnrollmentApplications(String filter, AdAcademicSession session, Integer offset,
			Integer limit);

	List<AdEnrollmentApplication> findEnrollmentApplications(String filter, AdAcademicSession session,
			AdStudent student, Integer offset, Integer limit);

	List<AdEnrollmentApplication> findEnrollmentApplications(String filter, AdAcademicSession session, AdStaff advisor,
			Integer offset, Integer limit);
	...
	List<AdEnrollment> findEnrollments(String filter, AdAcademicSession academicSession, AdOffering offering,
			Integer offset, Integer limit);
	...
	List<AdEnrollment> findEnrollments(AdAcademicSession academicSession, AdOffering offering, Integer offset,
			Integer limit);
	...
	AdAdmission findAdmissionBySessionProgramAndStudent(AdAcademicSession academicSession, AdProgram program,
			AdStudent student);
	...
	List<AdAppointment> findAppointments(AdAcademicSession academicSession, AdStaff staff, Integer offset,
			Integer limit);
