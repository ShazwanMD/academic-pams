...
public interface AcademicConstants {
    ...
    public static final String GRADUATION_APPLICATION_REFERENCE_NO = "AdGraduationApplication.referenceNo";
    ...
    public static final String GRADUATION_APPLICATION_ID = "graduationApplicationId";
	...
	public static final String GRADUATION_APPLICATION_PROCESS_KEY = "graduation_application_workflow";
	public static final String GRADUATION_APPLICATION_RESOURCE_PATH = "graduation_application.bpmn20.xml";
	public static final String GRADUATION_APPLICATION_PROCESS_NAME = "graduation_application";
