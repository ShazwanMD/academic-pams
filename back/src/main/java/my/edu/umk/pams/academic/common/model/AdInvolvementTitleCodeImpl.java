...
public class AdInvolvementTitleCodeImpl implements AdInvolvementTitleCode {
    ...
    @GeneratedValue(generator = "SQ_AD_INVT_TTLE_CODE")
    @SequenceGenerator(name = "SQ_AD_INVT_TTLE_CODE", sequenceName = "SQ_AD_INVT_TTLE_CODE", allocationSize = 1)
    private Long id;
    ...
    public Class<?> getInterfaceClass() {
        return AdInvolvementTitleCode.class;
    }
}
