...
INSERT INTO AD_STDN (ID, STUDENT_STATUS, COHORT_ID,STUDY_MODE_ID) VALUES (currval('SQ_AD_ACTR'), 0, 1,1);
...
INSERT INTO AD_ACTR (ID, IDENTITY_NO, NAME, EMAIL, PHONE, MOBILE, FAX, ACTOR_TYPE, C_TS, C_ID, M_ST)
VALUES
  (nextval('SQ_AD_ACTR'), '01001A', 'lecturer ONE', 'lecturer1@umk.edu.my', NULL, NULL, NULL, 0,
                          CURRENT_TIMESTAMP, 1, 1);
...
INSERT INTO AD_ACTR (ID, IDENTITY_NO, NAME, EMAIL, PHONE, MOBILE, FAX, ACTOR_TYPE, C_TS, C_ID, M_ST)
VALUES
  (nextval('SQ_AD_ACTR'), '01002A', 'lecturer TWO', 'lecturer2@umk.edu.my', NULL, NULL, NULL, 0,
                          CURRENT_TIMESTAMP, 1, 1);
