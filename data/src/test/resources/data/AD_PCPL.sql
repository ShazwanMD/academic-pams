...
INSERT INTO AD_PCPL (ID, NAME, ENABLED, LOCKED, PRINCIPAL_TYPE, M_ST, C_ID, C_TS) VALUES (nextval('SQ_AD_PCPL'), 'pps', TRUE, TRUE, 0, 1, 1, CURRENT_TIMESTAMP);
INSERT INTO AD_USER (ID, REAL_NAME, EMAIL, PASSWORD)
VALUES (currval('SQ_AD_PCPL'), 'PAMS PPS', 'pps@umk.edu.my', 'abc123');

INSERT INTO AD_PCPL (ID, NAME, ENABLED, LOCKED, PRINCIPAL_TYPE, M_ST, C_ID, C_TS) VALUES (nextval('SQ_AD_PCPL'), 'pps-kerani', TRUE, TRUE, 0, 1, 1, CURRENT_TIMESTAMP);
INSERT INTO AD_USER (ID, REAL_NAME, EMAIL, PASSWORD)
VALUES (currval('SQ_AD_PCPL'), 'PAMS PPS Kerani', 'pps-kerani@umk.edu.my', 'abc123');

INSERT INTO AD_PCPL (ID, NAME, ENABLED, LOCKED, PRINCIPAL_TYPE, M_ST, C_ID, C_TS) VALUES (nextval('SQ_AD_PCPL'), 'pps-pegawai', TRUE, TRUE, 0, 1, 1, CURRENT_TIMESTAMP);
INSERT INTO AD_USER (ID, REAL_NAME, EMAIL, PASSWORD)
VALUES (currval('SQ_AD_PCPL'), 'PAMS PPS Pegawai', 'pps-pegawai@umk.edu.my', 'abc123');
