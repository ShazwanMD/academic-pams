...
INSERT INTO AD_RFRN_NO (ID, CODE, CURRENT_VALUE, DESCRIPTION, INCREMENT_VALUE, PREFIX, REFERENCE_FORMAT, SEQUENCE_FORMAT, M_ST, C_ID, C_TS )
VALUES (nextval('SQ_AD_RFRN_NO'), 'AdGraduationApplication.referenceNo', 1, 'Graduation Application Reference No Format', 1, 'GRDN', '{#academicSession.getCode()}-{#j}', '000', 1, 0, CURRENT_TIMESTAMP );
