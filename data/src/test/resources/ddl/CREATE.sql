    ...
    alter table AD_ACDM_CLDR
        add constraint FK9351992FEE2B2AAA
    ...
    alter table AD_ACDM_SESN
        add constraint FK9358C6A54F290AA9
        foreign key (PREVIOUS_ID)
        references AD_ACDM_SESN;

    alter table AD_ACDM_SESN
        add constraint FK9358C6A5E48DE4EA
        foreign key (YEAR_ID)
    ...
    alter table AD_ADMN
        add constraint FKE7D7E3A0F5E26B71
        foreign key (PROGRAM_ID)
        references AD_PRGM;

    alter table AD_ADMN
        add constraint FKE7D7E3A0EE2B2AAA
        foreign key (SESSION_ID)
        references AD_ACDM_SESN;
    ...
    alter table AD_ASMT
        add constraint FKE7D81BF5AE984A23
        foreign key (OFFERING_ID)
        references AD_OFRG;

    alter table AD_ASMT
        add constraint FKE7D81BF5EE2B2AAA
        foreign key (SESSION_ID)
        references AD_ACDM_SESN;
    ...
    alter table AD_BNDL_SBJT
        add constraint FK9C953E4893C0867E
        foreign key (ID)
        references AD_SBJT;

    alter table AD_BNDL_SBJT_PART
        add constraint FK453E838A11773039
        foreign key (BUNDLE_ID)
        references AD_BNDL_SBJT;

    alter table AD_BNDL_SBJT_PART
        add constraint FK453E838A866369C3
    ...
    alter table AD_CHRG_SCDL
        add constraint FK9DA1A581EB892683
        foreign key (COHORT_ID)
        references AD_CHRT;

    alter table AD_CHRG_SCDL
        add constraint FK9DA1A581F5E26B71
        foreign key (PROGRAM_ID)
        references AD_PRGM;
    ...
    alter table AD_CRSE
        add constraint FKE7D9019D24516F71
        foreign key (FACULTY_ID)
        references AD_FCTY;

    alter table AD_CRSE_MMBR
        add constraint FKDDE75B52866369C3
        foreign key (COURSE_ID)
        references AD_CRSE;

    alter table AD_CRSE_MMBR
        add constraint FKDDE75B527F053AE4
        foreign key (MEMBER_ID)
        references AD_CRSE;

    alter table AD_CRSE_PQST
        add constraint FKDDE8C984866369C3
        foreign key (COURSE_ID)
        references AD_CRSE;

    alter table AD_CRSE_PQST
        add constraint FKDDE8C9849071D48
    ...
    alter table AD_ENMT
        add constraint FKE7D9DAAC3437F04F
    ...
    alter table AD_OFRG
        add constraint FKE7DE48E8866369C3
        foreign key (COURSE_ID)
        references AD_CRSE;

    alter table AD_OFRG
        add constraint FKE7DE48E8F5E26B71
        foreign key (PROGRAM_ID)
        references AD_PRGM;
    ...
    alter table AD_PRCS_CLDR
        add constraint FK2EDC93C8EE2B2AAA
        foreign key (SESSION_ID)
        references AD_ACDM_SESN;
    ...
    alter table AD_PRGM
        add constraint FKE7DEE90424516F71
        foreign key (FACULTY_ID)
        references AD_FCTY;
    ...
    alter table AD_SBJT
        add constraint FKE7E00A755176A943
        foreign key (CURRICULUM_ID)
        references AD_CRLM;
    ...
    alter table AD_SCTN
        add constraint FKE7E00F66AE984A23
        foreign key (OFFERING_ID)
        references AD_OFRG;

    alter table AD_SCTN
        add constraint FKE7E00F66EE2B2AAA
        foreign key (SESSION_ID)
        references AD_ACDM_SESN;

    alter table AD_SCTN_PLCY
        add constraint FK503FDCAB24516F71
        foreign key (FACULTY_ID)
        references AD_FCTY;
    ...
    alter table AD_SITE_OFRG
        add constraint FKB02AC328F5E26B71
        foreign key (PROGRAM_ID)
        references AD_PRGM;

    alter table AD_SITE_OFRG
        add constraint FKB02AC3288C3FCA83
        foreign key (SITE_ID)
        references AD_SITE;
    ...
    alter table AD_SNGL_SBJT
        add constraint FK13D34F1C866369C3
        foreign key (COURSE_ID)
        references AD_CRSE;

    alter table AD_SNGL_SBJT
        add constraint FK13D34F1C93C0867E
        foreign key (ID)
        references AD_SBJT;
    ...
    alter table Ad_ENMT_APPL
        add constraint FKDFAFC43E3437F04F
        foreign key (ADMISSION_ID)
        references AD_ADMN;
