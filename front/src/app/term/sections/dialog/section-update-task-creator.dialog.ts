...
@Component({
  selector: 'pams-section-update-task-creator',
  templateUrl: './section-update-task-creator.dialog.html',
})

export class SectionUpdateTaskCreatorDialog implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder,
              ...
              private dialog: MdDialogRef<SectionUpdateTaskCreatorDialog>) {
  }
