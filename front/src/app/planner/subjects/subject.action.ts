...
//      static FIND_SUBJECT_BY_CURRICULUM = '[Subject] Find Subject';
//     findSubjectByCurriculum( curriculum ): Action {
//         return {
//             type: SubjectActions.FIND_SUBJECT_BY_CURRICULUM,
//             payload: curriculum
//         };
//     }

//      static FIND_SUBJECT_BY_CURRICULUM_SUCCESS = '[Subject] Find Subject';
//     findSubjectByCurriculumSuccess( curriculum ): Action {
//         return {
//             type: SubjectActions.FIND_SUBJECT_BY_CURRICULUM,
//             payload: curriculum
//         };
...
//     static REMOVE_SUBJECT = '[Subject] Remove Subject';
//     removeSubject( subject ): Action {
//         return {
...
//     static REMOVE_SUBJECT_SUCCESS = '[Subject] Remove Subject Success';
//     removeSubjectSuccess( subject ): Action {
//         return {
//             type: SubjectActions.REMOVE_SUBJECT_SUCCESS,
//             payload: subject
//         };
//     }
