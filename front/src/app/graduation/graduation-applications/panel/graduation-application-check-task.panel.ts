...
@Component({
  selector: 'pams-graduation-application-check-task',
  templateUrl: './graduation-application-check-task.panel.html',
})

export class GraduationApplicationCheckTaskPanel implements OnInit {
