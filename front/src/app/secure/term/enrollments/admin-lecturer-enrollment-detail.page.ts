...
@Component({
  selector: 'pams-admin-lecturer-enrollment-detail',
  templateUrl: './admin-lecturer-enrollment-detail.page.html',
})

export class AdminLecturerEnrollmentDetailPage implements OnInit {
