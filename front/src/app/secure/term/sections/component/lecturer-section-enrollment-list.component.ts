...
@Component({
  selector: 'pams-lecturer-section-enrollment-list',
  templateUrl: './lecturer-section-enrollment-list.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class LecturerSectionEnrollmentListComponent implements AfterViewInit {
