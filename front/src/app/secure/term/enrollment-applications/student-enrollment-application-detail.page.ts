...
@Component({
  selector: 'pams-student-enrollment-application-detail',
  templateUrl: './student-enrollment-application-detail.page.html',
})
export class StudentEnrollmentApplicationDetailPage implements OnInit {
