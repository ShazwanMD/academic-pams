...
import {EnrollmentApplicationItemHistoryComponent} from './component/enrollment-application-item-list-history.component';
...
@NgModule({
  ...
  declarations: [
    ...
    EnrollmentApplicationItemsComponent,
    EnrollmentApplicationItemHistoryComponent,
