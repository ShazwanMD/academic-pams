...
import { gradebookMatrixListReducerSection, GradebookMatrixListStateSection } from './sections/gradebook-matrix-list.reducer';
...
export interface TermModuleState {
    ...
    gradebookMatricesSection: GradebookMatrixListStateSection;
}
;
...
export const INITIAL_TERM_STATE: TermModuleState = <TermModuleState>{
    ...
    gradebookMatricesSection: <GradebookMatrix[]>[],
};
...
export const termModuleReducers = {
    ...
    gradebookMatricesSection: gradebookMatrixListReducerSection,
};
