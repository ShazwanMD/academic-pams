...
@Component( {
    selector: 'pams-admission-application-manual',
    templateUrl: './admission-application-manual.dialog.html',
} )

export class AdmissionApplicationManualDialog implements OnInit {
