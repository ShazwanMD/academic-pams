...
@Component({
  selector: 'pams-admission-profile-list',
  templateUrl: 'admission-profile-list.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class AdmissionProfileListComponent implements AfterViewInit {
