...
@Component({
  selector: 'pams-student-admission-center',
  templateUrl: './student-admission-center.page.html',
})
export class StudentAdmissionCenterPage implements OnInit {
  ...
  viewAdmission(admission: Admission) {
    ...
    this.router.navigate(['/secure/term/admissions', admission.id, 'student-admission-detail']);
