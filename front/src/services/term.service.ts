...
export class TermService {
   ...
   /* //find admissionbystudentandsession
    ...
    //administrator: add enrollment application items
    ...
    //student: add enrollment application items
    ...
    deleteStudentEnrollmentApplicationItem( application: EnrollmentApplication, item: EnrollmentApplicationItem ) {
        return this._http.delete( this.TERM_API + '/enrollmentApplications/' + application.referenceNo + '/enrollmentApplicationItems/' + item.id )
            .flatMap(( res: Response ) => Observable.of( res.text() ) );
    }
