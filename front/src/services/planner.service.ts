...
export class PlannerService {
  ...
  findSubjectsByCurriculumAndSubjectTypeCoreElective(curriculum: Curriculum): Observable<Subject[]> {
      console.log('findSubjectsByCurriculumAndSubjectTypeCoreElective');
  ...
  // // findBundleSubjectsByCurriculum(curriculum: Curriculum): Observable<BundleSubject[]> {
  // //   console.log('findSubjects');
  // //   return this._http.get(this.PLANNER_API + '/curriculums/' + curriculum.code + '/bundleSubjects')
  // //     .map((res) => <Subject[]>res.json());
  // }
  ...
  addBundleSubject(curriculum: Curriculum, subject: BundleSubject): Observable<String> {
   ...
   addSubjectPart(bundleSubject: BundleSubject, subject: BundleSubjectPart): Observable<String> {
    ...
    deleteSubject(curriculum: Curriculum, subject: Subject) {
    return this._http.delete(this.PLANNER_API + '/curriculums/' + curriculum.code + '/subjects/' + subject.id)
      .flatMap((res: Response) => Observable.of(res.text()));
  }

   deleteSubjectPart(bundleSubject: BundleSubject, subject: BundleSubjectPart): Observable<String> {
     console.log('bundleSubject:', subject);
